  ...
  return (
    <div id="f5-landing-root" className="min-h-screen bg-[#050505] text-white selection:bg-red-600 selection:text-white font-sans">
      ...
      <section id="hero" className="relative h-auto min-h-[560px] lg:h-[560px] px-5 sm:px-8 pt-8 lg:pt-12 flex flex-col justify-end pb-10 lg:pb-16 overflow-hidden border-b border-white/5">
        <div className="absolute inset-0 bg-gradient-to-r from-[#071a33] via-[#071a33]/80 to-transparent z-10" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#071a33] to-transparent z-10" />
