...
function f5tv_rest_handle_catalog(WP_REST_Request $request): WP_REST_Response
{
    ...
    while ($query->have_posts()) {
        ...
        $response[] = [
            ...
            'cast'             => $cast,
            'directors'        => $directors,
            'coverUrl'         => get_field('cover_url', $post_id) ?: get_the_post_thumbnail_url($post_id, 'f5tv-content-cover') ?: 'https://images.unsplash.com/photo-1594909122845-11baa439b7bf?q=80&w=600',
            'bannerUrl'        => get_field('banner_url', $post_id) ?: get_the_post_thumbnail_url($post_id, 'f5tv-content-banner') ?: 'https://images.unsplash.com/photo-1594909122845-11baa439b7bf?q=80&w=1200',
