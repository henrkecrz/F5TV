...
<head>
    ...
    <?php wp_head(); ?>
    <?php
    // Mantém o favicon da marca como a última definição do head, após plugins e o ícone do site do WordPress.
    $f5tv_favicon_path = get_template_directory() . '/assets/icons/favicon-32.png';
