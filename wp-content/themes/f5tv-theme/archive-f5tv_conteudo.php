<?php
/**
 * Archive template for F5TV Content
 */
...
<div class="min-h-screen bg-f5-blue text-white font-sans">
    <section class="px-4 sm:px-8 py-12 border-b border-white/5">
        <div class="max-w-7xl mx-auto">
            <span class="text-[10px] font-mono font-bold tracking-[0.2em] text-f5-red uppercase">CATÁLOGO</span>
            <h1 class="text-3xl md:text-5xl font-black tracking-tighter text-white mt-2">
                <?php echo single_term_title('', false); ?>
            </h1>
            <?php if (term_description()): ?>
                <p class="text-white/60 text-base mt-2 max-w-2xl"><?php echo term_description(); ?></p>
            <?php endif; ?>
        </div>
    </section>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-8 py-12">
        ...
        <?php else: ?>
            <div class="text-center py-20">
                <p class="text-zinc-500 text-sm">Nenhum conteúdo encontrado nesta categoria.</p>
            </div>
        <?php endif; ?>
    </main>
</div>
